...
class TradeTracker:
    ...
    def register_open_trade(self, symbol: str, order_id: str, trade_pk: int) -> None:
    ...
    def update_positions(self) -> List[Dict[str, Any]]:
        ...
        for symbol in closed_symbols:
            ...
            if self.storage and meta.get("order_id"):
                try:
                    ...
                    if meta.get("trade_pk") is not None:
                        self.storage.delete_position_by_trade_pk(int(meta["trade_pk"]))
